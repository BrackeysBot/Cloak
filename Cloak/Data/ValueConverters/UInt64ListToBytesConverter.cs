...
namespace Cloak.Data.ValueConverters;

/// <summary>
///     Converts a <see cref="List{T}" /> of <see cref="Uri" /> values to and from an array of bytes.
/// </summary>
internal sealed class UInt64ListToBytesConverter : ValueConverter<IReadOnlyList<ulong>, byte[]>
{
    /// <summary>
    ...
    private static byte[] ToBytes(IReadOnlyList<ulong> values)
    {
    ...
    private static IReadOnlyList<ulong> FromBytes(byte[] bytes)
    {
